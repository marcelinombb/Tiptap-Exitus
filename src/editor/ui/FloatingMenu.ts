...
import { CellSelection } from '@src/extensions/table/prosemirror-tables/src/cellselection'
...
export class BubbleMenuView implements PluginView {
  ...
  updatePosition() {
    ...
    computePosition(virtualElement, this.element, {
      ...
      console.log(this.element, this.element.getBoundingClientRect(), this.element.clientWidth, this.element.offsetWidth);

      //console.log(virtualElement.getBoundingClientRect().x + (virtualElement.getBoundingClientRect().width/2) - (elWidht / 2));
      this.element.style.width = 'max-content'
      this.element.style.position = strategy
      this.element.style.left = `${x}px`
      this.element.style.top = `${y}px`

      console.log(x, y, virtualElement.getBoundingClientRect());
...
export const FloatingMenuPlugin = (options: BubbleMenuPluginProps) => {
  return new Plugin({
